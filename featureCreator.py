...
def create_features(pickle_filename, section_count, get_boundaries):
  filepaths, _, _, _ = jm.get_images_metadata()
  jm.save_clip_section_features(filepaths, pickle_filename, section_count, lambda filename: get_image_sections(filename, get_boundaries))

#create_features("corner_and_centerpiece_features.pickle", 5, get_corner_and_centerpiece_boundaries)
#create_features("corner_and_centerpiece_overlap_features.pickle", 5, get_corner_and_centerpiece_overlap_boundaries)
